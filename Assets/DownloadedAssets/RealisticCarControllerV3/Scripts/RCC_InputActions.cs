...
public partial class @RCC_InputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IOptionalActions> m_OptionalActionsCallbackInterfaces = new List<IOptionalActions>();
    ...
    public struct OptionalActions
    {
        ...
        public void AddCallbacks(IOptionalActions instance)
        {
            if (instance == null || m_Wrapper.m_OptionalActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_OptionalActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IOptionalActions instance)
        {
            @SlowMotion.started -= instance.OnSlowMotion;
            @SlowMotion.performed -= instance.OnSlowMotion;
            @SlowMotion.canceled -= instance.OnSlowMotion;
        ...
        public void RemoveCallbacks(IOptionalActions instance)
        {
            if (m_Wrapper.m_OptionalActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IOptionalActions instance)
        {
            foreach (var item in m_Wrapper.m_OptionalActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_OptionalActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
