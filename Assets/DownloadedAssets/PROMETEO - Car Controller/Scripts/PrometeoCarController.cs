    ...
    */
    ...
    void AnimateWheelMeshes()
    {
        try
        {
            ...
            Quaternion addedRotation = Quaternion.Euler(0, 180, 0);  // Create a quaternion representing a 180-degree rotation around the y-axis
            frontLeftMesh.transform.rotation = FLWRotation * addedRotation;  // Combine the original rotation with the added rotation
            ...
            rearLeftMesh.transform.rotation = RLWRotation * addedRotation;  // Combine the original rotation with the added rotation;
